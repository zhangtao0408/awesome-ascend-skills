...
- **文档**: [npu-smi/SKILL.md](../base/npu-smi/SKILL.md)
- **类型**: 运维
...
- **文档**: [hccl-test/SKILL.md](../training/hccl-test/SKILL.md)
- **类型**: 测试
...
- **文档**: [ascend-docker/SKILL.md](../base/ascend-docker/SKILL.md)
- **类型**: 运维
...
- **文档**: [torch_npu/SKILL.md](../base/torch_npu/SKILL.md)
- **类型**: 通用框架
- **范围**:
  - ✅ PyTorch 算子 API
  - 📋 … (待规划）
...
- **文档**: [vllm-ascend/SKILL.md](../inference/vllm-ascend/SKILL.md)
- **类型**: 推理
- **范围**:
  - ✅ 部署
  - ✅ 适配
...
- **文档**: [ais-bench/SKILL.md](../inference/ais-bench/SKILL.md)
- **类型**: 测试
- **范围**:
...
- **文档**: [atc-model-converter/SKILL.md](../inference/atc-model-converter/SKILL.md)
- **类型**: 推理优化
- **范围**:
  - ONNX 转 OM
  - 精度对比
...
- **文档**: [msmodelslim/SKILL.md](../inference/msmodelslim/SKILL.md)
- **类型**: 推理优化
- **范围**:
  - 模型量化
  - 精度调优
...
- **文档**: [ascendc/SKILL.md](../ops/ascendc/SKILL.md)
- **类型**: 算子开发
- **范围**:
  - FFN/GMM/MoE 等算子
  - CANN API 示例
